...
raylibpong: raylib
ifneq (,$(raylibpong_config))
	@echo "==== Building raylibpong ($(raylibpong_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f raylibpong.make config=$(raylibpong_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f raylibpong.make clean
